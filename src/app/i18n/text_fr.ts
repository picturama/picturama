export default {
    ...
    ImportProgressButton_phase_scanDirs: 'Scan des dossiers en cours',
    ImportProgressButton_phase_cleanup: 'Nettoyage en cours',
    ImportProgressButton_phase_importPhotos: 'Importation en cours',
    ...
    MainMenu_about: 'À propos de Picturama',
    MainMenu_settings: 'Paramètres',
    MainMenu_quit: `Quitter`,
    MainMenu_hide: 'Masquer Picturama',
    MainMenu_hideOthers: 'Masquer les autres',
    MainMenu_showAll: 'Tout afficher',
    ...
    PhotoDetailPane_prevSection: 'Section précédente : {0}',
    PhotoDetailPane_nextSection: 'Section suivante : {0}',
    ...
    PhotoInfo_segmentNotRead: `Non lu par Picturama`,
