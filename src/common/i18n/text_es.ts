export default {
    ...
    Library_noSettings_message:
        "Haz click en el {0} arriba para abrir los ajustes.",
    Library_noPhotos_message:
        "Presiona {0} o el botón más abajo para empezar el escaneo de las fotos en las carpetas.",
    ...
    Library_selectOtherView:
        "Por favor, selecciona otra vista en la parte superior a la izquierda.",
    ...
    LibraryTopBar_emptyTrashQuestion:
    ...
    PhotoActionButtons_restoredFromTrash_more:
        "Restauradas {0} fotos de la papelera",
    ...
    PhotoActionButtons_photoInfo:
        "Mostrar información sobre la foto seleccionada",
    ...
    PhotoInfo_noSelection_message:
        "Por favor, selecciona una foto de la izquierda.",
    ...
    Settings_selectPhotoDirs:
        "Por favor, selecciona carpetas para escanear imágenes.",
